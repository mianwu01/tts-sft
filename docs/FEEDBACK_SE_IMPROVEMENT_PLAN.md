...
| **P4 B-arm attribution** | ✅ **COMPLETE (06-12 04:48) — attribution resolved** | Harvest A 3,657 / B 3,852 / C 3,983 / C2 3,992 → **wording +195, vfonly feedback +131, disagreement +9**. **Feedback preserves the frontier** (C reach 85/85/85 vs B eroding 86→81→82→80) and is **solely responsible for the robust reachability gain** (lcbv6-120: C 7 traces + C2 multi-trace, NEVER reached by A/B; the shared {004} is a fragile 1-trace borderline in both B and C). Full table in `docs/LCB_FEEDBACK_SE_C2_B_RUN.md`. |
